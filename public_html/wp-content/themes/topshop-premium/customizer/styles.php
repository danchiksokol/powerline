...
function customizer_library_topshop_build_styles() {
    ...
    $navcolor = 'topshop-nav-color';
    $footercolor = 'topshop-footer-color';
    
    $colormod = get_theme_mod( $color, customizer_library_get_default( $color ) );
    
    $navcolormod = get_theme_mod( $navcolor, customizer_library_get_default( $navcolor ) );
    $footercolormod = get_theme_mod( $footercolor, customizer_library_get_default( $footercolor ) );
    ...
    if ( $navcolormod !== customizer_library_get_default( $navcolor ) ) {

        $navsancolor = sanitize_hex_color( $navcolormod );
        ...
        Customizer_Library_Styles()->add( array(
            ...
            'declarations' => array(
                'background-color' => $navsancolor
            )
        ) );
    }
    
    if ( $footercolormod !== customizer_library_get_default( $footercolor ) ) {

        $footersancolor = sanitize_hex_color( $footercolormod );
        ...
        Customizer_Library_Styles()->add( array(
            ...
            'declarations' => array(
                'background-color' => $footersancolor
            )
        ) );
    }
