...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'topshop-premium' ),
		'cyrillic'     => __( 'Cyrillic', 'topshop-premium' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'topshop-premium' ),
		'devanagari'   => __( 'Devanagari', 'topshop-premium' ),
		'greek'        => __( 'Greek', 'topshop-premium' ),
		'greek-ext'    => __( 'Greek Extended', 'topshop-premium' ),
		'khmer'        => __( 'Khmer', 'topshop-premium' ),
		'latin'        => __( 'Latin', 'topshop-premium' ),
		'latin-ext'    => __( 'Latin Extended', 'topshop-premium' ),
		'vietnamese'   => __( 'Vietnamese', 'topshop-premium' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'topshop-premium' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'topshop-premium' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'topshop-premium' ),
