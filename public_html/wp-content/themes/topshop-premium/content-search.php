...
$post_blog_layout = '';
if ( get_theme_mod( 'topshop-blog-layout', false ) ) {
    $post_blog_layout = ' ' . get_theme_mod( 'topshop-blog-layout' );
} ?>
        ...
        <div class="post-loop-images-carousel-wrapper post-loop-images-carousel-wrapper-remove">
            ...
            <div class="post-loop-images-carousel post-loop-images-carousel-remove">
                ...
                foreach ( $images as $image ) {
                    ...
                    if ( get_theme_mod( 'topshop-blog-layout', false ) == 'blog-post-side-layout' ) {
                        $thumbimage = wp_get_attachment_image_src( $image->ID, 'topshop_blog_img_side' );
                    } else {
                        $thumbimage = wp_get_attachment_image_src( $image->ID, 'topshop_blog_img_top' );
                    } ?>
