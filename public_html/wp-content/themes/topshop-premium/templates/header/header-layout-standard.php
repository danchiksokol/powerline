...
<div class="site-container">
    ...
    <div class="site-header-center">
            ...
            <img src="http://plg.bragin.ru/wp-content/uploads/2016/03/Power-Line-Group-Apple-Authorised-Reseller-335x91.jpg" alt="Power Line Group Apple Authorised Reseller" height="91" width="335" border="0">
    ...
    <div class="site-header-right">
        ...
        if ( topshop_is_woocommerce_activated() ) { ?>
            ...
            <?php if ( is_user_logged_in() ) { ?>
                <div class="site-header-right-link"><a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>" title="<?php _e('Мой кабинет','topshop-premium'); ?>"><?php _e('Мой кабинет','topshop-premium'); ?></a></div>
            <?php } else { ?>
                <div class="site-header-right-link"><a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>" title="<?php _e('Войти? Login','topshop-premium'); ?>"><?php _e('Войти / Зарегистироваться','topshop-premium'); ?></a></div>
            <?php } ?>
