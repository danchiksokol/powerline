...
#### 10.2.3
* SEO improvements & Style tweaks
* Added slider autoscroll setting
* Updated help links in Customizer settings
* Fixed textdomain error
* Updated language .pot file

#### 10.2.2
* Fix bug with mobile navigation styling
* Fix blog to use featured image
* Add extra blog setting
* Exclude set slider category from sidebar categories widget
* Styling tweaks
* Update language .pot file

#### 10.2.1
* Nested the mobile navigation
* Fixed javascript error when sticky nav disabled
